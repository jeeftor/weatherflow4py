...
def print_message_count():
    ...
    print(f"Received {total_messages}/{NUMBER_OF_MESSAGES} messages. {remaining} remaining.")
...
async def main():
    ...
    while sum(message_counter.values()) < NUMBER_OF_MESSAGES or not REQUIRED_MESSAGE_TYPES.issubset(received_message_types):
